    ...
    return (
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="text-sm text-muted-fg">Tap to continue</div>
        </div>
          ...
          >
            ...
            {activeTemplates.length === 0 ? (
              <div className="text-center py-6 space-y-4">
                <div className="text-sm text-muted">No active templates. Create one to get started.</div>
                <Link
                  href="/gym/templates/new"
                  className="inline-flex items-center gap-2 rounded-xl bg-accent px-5 py-3 text-sm font-bold text-bg"
