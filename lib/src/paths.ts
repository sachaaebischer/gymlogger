...
export const paths = {
  ...
  planWeek: (weekStart: string) => path.join(dataDir(), "plan", `${weekStart}.json`),
  ...
  plannedSessionsDir: () => path.join(dataDir(), "plan", "sessions"),
  plannedSession: (date: string) => path.join(dataDir(), "plan", "sessions", `${date}.json`),
  weekActivitiesDir: () => path.join(dataDir(), "plan", "activities"),
  weekActivities: (weekStart: string) => path.join(dataDir(), "plan", "activities", `${weekStart}.json`),
};
